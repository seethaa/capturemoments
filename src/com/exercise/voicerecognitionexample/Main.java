/**
 * Activity to connect the app to Bluetooth
 */
...
public class Main extends Activity implements OnClickListener {
		...
		btnDisconnect.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getApplicationContext(),
						"Bluetooth Status " + str, Toast.LENGTH_SHORT).show();
			}
		});
		CheckBt();
	...
	/**
	 * The function check if bluetooth of android and arduino are paired. If no
	 * connection, it will enable the android bluetooth.
	 */
	...
	/**
	 * Function to pair bluetooth of Android and Arduino Max 3 attempts are
	 * made, after which the function gives up.
	 * 
	 */
	public void Connect() {
	...
	/**
	 * Write data on to output stream to be sent to the bluetooth of arduino
	 * 
	 * @param data
	 */
	...
	/**
	 * Function to listen to data sent by arduino bluetooth, It runs in separate
	 * thread
	 */
