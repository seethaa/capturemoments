...
public class VoiceRecognitionActivity extends Activity {
	...
	/**
	 * This function calls the intent to handle voice recognition
	 * 
	 * @param view
	 */
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == VOICE_RECOGNITION_REQUEST_CODE)
			...
			if (resultCode == RESULT_OK) {
				...
				String tempResult = textMatchList.get(0);
				System.out.println("found: " + tempResult);

				if (tempResult.equalsIgnoreCase("haha")) {
					Intent myIntent = new Intent(VoiceRecognitionActivity.this,
							AndroidCamera.class);
